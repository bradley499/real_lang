...
int main(int argc, char *argv[])
{
	...
	for (int i = 1; i < argc; i++)
	{
		...
		{
			std::cout<<lan_intro<<std::endl<<"Usage: [options] {-i input_path} ... {-o output_path}"<<std::endl<<"Packages the Real language into a portable interpretive redistributable package"<<std::endl<<std::endl<<"List of options:"<<std::endl<<"  -i, --input <file>       Expects the Real language input file path to be"<<std::endl<<"                           subsequently appended after this argument"<<std::endl<<"  --no-color, --no-colour  Removes all colour from any outputs"<<std::endl<<"  -o, --output <file>      Expects the file path of the package output file"<<std::endl<<"                           to be subsequently appended after this statment"<<std::endl<<"  --raw                    Outputs the raw packaged program to the console"<<std::endl<<"  -v, --verbose            Gives a verbose output of what is currently"<<std::endl<<"                           occuring"<<std::endl<<"  --verion                 Prints out the version number, release number, and"<<std::endl<<"                           compilation time"<<std::endl;
			return 0;
		}
